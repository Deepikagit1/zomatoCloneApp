...
function Wallpaper(props) {
  ...
  let getLocationList = async (event) => {
    ...
    let URL = "https://nameless-mountain-02509.herokuapp.com/api/get-location-by-city?city=" + city;
    try {
  ...
  let getRestaurantDetails = async (event) => {
    ...
    let URL = `https://nameless-mountain-02509.herokuapp.com/api/get-restaurant-by-location-id?lid=${selectLoc.location_id}&rest=${restaurant}`;
    try {
      let response = await axios.get(URL);
