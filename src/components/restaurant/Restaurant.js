...
function Restaurant(props) {
  ...
  let initialValues = {fullname: "", email: "",address:""};
  ...
  let makePayment = async () => {
    ...
    let URL = "https://nameless-mountain-02509.herokuapp.com/api/payment";
    ...
    var options = {
      ...
      handler: async function (response) {
        let URL = "https://nameless-mountain-02509.herokuapp.com/api/callback";
        let sendData = {
  ...
  let getRestaurantDetails = async () => {
    let URL = "https://nameless-mountain-02509.herokuapp.com/api/get-restaurant-by-id/" + params.id;
    try {
  ...
  let getMenuList = async () => {
    let URL = "https://nameless-mountain-02509.herokuapp.com/api/get-menu-item?rid=" + params.id;
    try {
      let response = await axios.get(URL);
      let data = response.data;
      if (data.status === true) {
  ...
  return (
    <>
      <div
        ...
        aria-hidden="true"
      >
        <div className="modal-dialog modal-lg " style={{ height: "50vh" }}>
        ...
        <div className="modal-dialog modal-dialog-centered">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-body">
              ...
              {Object.keys(formErrors).length !== 0 ? (<button className="btn btn-success float-end mb-2 " onClick={makePayment}>
                PROCEED
              </button>) : (
